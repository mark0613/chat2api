...
from utils.configs import pipeline_api_key, pipeline_api_url, pipeline_enable
...
class PipelineManager:
    ...
    async def _make_request(
        ...
        **kwargs,
        ...
        try:
            ...
            logger.error(f'Error during pipeline API request ({method} {url}): {str(e)}')
            raise
    ...
    async def update_pipeline_valves(
        ...
        return await self._make_request('POST', f'/{pipeline_id}/valves/update', json=valves)
    ...
    async def upload_pipeline(
        ...
        try:
            ...
            raise ValueError(f'Could not connect to Pipeline API at {url} for upload') from e
        except Exception as e:
